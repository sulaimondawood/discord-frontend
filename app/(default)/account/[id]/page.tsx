...
const Page = async ({ params }: { params: { id: number } }) => {
  ...
  return (
    <>
      <div className="hidden md:block bg-gray-ish h-screen py-14 px-6 lg:px-10 ml-[330px] w-[calc(100vw-330px)]">
        <h1 className="text-white text-xl font-semibold">My Account</h1>
        <div className="bg-room-deep-black md:w-[400px] lg:w-[650px] rounded-md mt-6 pb-5 h-fit">
