...
const SideBar = () => {
  ...
  return (
    <>
      ...
      >
        <div className="w-14 md:w-[80px] h-screen overflow-auto bg-room-deep-black py-4 px-1 md:px-2">
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex flex-col gap-4">
              <button className="text-green-500 hover:bg-green-500 hover:rounded-2xl hover:scale-100 hover:text-green-50 text-2xl bg-white/10 backdrop-blur-md p-3 rounded-full transition-all duration-50000 ease-linear">
                <IoAdd />
              </button>
              <button className="text-green-500 hover:bg-green-500 hover:rounded-2xl hover:scale-100 hover:text-green-50 text-2xl bg-white/10 backdrop-blur-md p-3 rounded-full transition-all duration-50000 ease-linear">
                <IoMdArrowBack />
      ...
      <div className=" h-screen fixed flex md:hidden ">
        ...
        <div className="bg-room-black overflow-auto h-screen w-[calc(100vw-76px)] sm:w-[calc(100vw-196px)] md:w-[250px] px-1 md:px-3 py-4">
          ...
          <div className="mt-4 relative">
            ...
            <div onClick={handlePageState} className="mt-5">
